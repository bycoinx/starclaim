...
export const SENSOR_SMOOTHING_ALPHA = 0.15;
export const SENSOR_RENDER_INTERVAL_MS = 50;
export const SENSOR_HUD_INTERVAL_MS = 1000;
export const SENSOR_VIEW_TILT_SCALE = 0.6;
export const SENSOR_HEADING_EPSILON = 0.35;
export const SENSOR_TILT_EPSILON = 0.25;
