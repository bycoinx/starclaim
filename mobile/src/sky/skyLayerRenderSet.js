...
export const SKY_LAYER_BUDGET = Object.freeze({
  ...
  medium: Object.freeze({
    dsos: 12,
    planets: 6,
    constellationLabels: 10,
    constellationLines: 22,
    constellationBoundaries: 8,
    mythology: 0,
    constellationSegments: 180,
    boundarySegments: 90,
  }),
  high: Object.freeze({
    dsos: 24,
    planets: 8,
    constellationLabels: 18,
    constellationLines: 38,
    constellationBoundaries: 14,
    mythology: 8,
    constellationSegments: 320,
    boundarySegments: 160,
  }),
});
